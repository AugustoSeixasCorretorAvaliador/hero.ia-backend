export function buildPromptForMessage({ mensagem, empreendimentos }) {
  ...
  return [
    ...
    "- 5) Se nenhum item casar por nome ou bairro, responda apenas pedindo as referências com: 'Olá 👋, Para eu te direcionar com precisão, me diga, por favor, o nome do empreendimento ou o bairro com a tipologia (ex: studio, 2q, 3q, 4q, Lote). Assim, consigo te apresentar as opções mais adequadas dos empreendimentos. 😊'",
